...
const navigation: NavItem[] = [
  ...
  { name: 'Monthly Subscriptions', to: '/subscriptions', icon: CalendarCheck, superAdminOnly: true },
  { name: 'Reports', to: '/reports', icon: TrendingUp, ownerOnly: true },
  { name: 'Repair Price List', to: '/price-list', icon: BookOpen },
  { name: 'Create Repair Price', to: '/settings/create-price', icon: ClipboardList, superAdminOnly: true },
